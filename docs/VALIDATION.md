...
Five independent NOAA/USNO comparisons passed the stated angular/minute thresholds. For scientific release 1.0, remaining gates include cross-ray/spatial convergence bounds, the vertical-model uncertainty budget and a comprehensive physical interpretation of partial surface data. Therefore the released version remains 0.8.0.
