...
Release 0.9.1 is a research release. Working numerical models do not establish a universal physical error bound. In particular, spatial/angular sampling, missing distant terrain, near-horizon atmosphere and current vegetation limit predictions. Do not interpret displayed seconds as second-level observational accuracy.
